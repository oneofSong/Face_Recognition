...
class facenetRealtime():
    ...
    def __init__(self):
        ...
        print("face_cascade built :: /home/bit/anaconda3/envs/faceRecognition/lib/python3.7/site-packages/cv2/data/haarcascade_frontalface_default.xml")
        # ------------------------
    ...
    def runVideo(self):
        ...
        employee_pictures = "/home/bit/Downloads/blackpink_crop"
        ...
        cap = cv2.VideoCapture("/home/bit/Downloads/bp1.mp4")  # videoFile
